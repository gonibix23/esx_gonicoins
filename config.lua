...
Config.NumeroDeBitcoinsVendes = 1 --Número de Bitcoins que vendes
Config.MarkType = 1 -- Tipo de marca
Config.ProbabilidadDeRomperDisco = 100 -- Este numero indica entre cuanto es la posibilidad es decir si es 10 es 1/10 un 10% si es 100 es 1/100 un 1%
